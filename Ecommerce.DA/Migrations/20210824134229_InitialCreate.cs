    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProducts", x => new { x.ProductId, x.OrderId, x.CustomerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingCartItem", x => new { x.CartId, x.CustomerId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ShoppingCartItem_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_ProductId_OrderId_CustomerId",
                table: "OrderProducts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItem_CartId_CustomerId_ProductId",
                table: "ShoppingCartItem",
                columns: new[] { "CartId", "CustomerId", "ProductId" });
